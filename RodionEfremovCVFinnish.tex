...
\cvitem{\href{https://github.com/coderodde/ACM-DL-Crawler}{\color{blue} ACM DL Crawler}}{Rinnakkainen crawleri, joka hakee sisältöä verkosta ja organisoi sen tietokantaan.}
...
\cvitem{\href{http://t-rodionef.users.cs.helsinki.fi/rateapp/}{\color{blue} rateapp}}{Project in Practical Machine Learning -kurssin puiteissa kehitetty elokuvien suositussivu.}
